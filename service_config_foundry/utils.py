...
def convert_to_camel_case(name):
    # Split on underscores, capitalize each part, and join them back together.
...
def convert_to_snake_case(name):
    # Iterate through each character, prepend an underscore if the character is
    # uppercase, and convert it to lowercase. Strip any leading underscores.
    return "".join(
...
# - If both dictionaries contain a key with a dictionary as its value, merge
#   the inner dictionaries.
# - Otherwise, the value from the second dictionary overwrites the value in the
#   first dictionary.
# Example:
# dict1 = {"a": 1, "b": {"x": 2}}
# dict2 = {"b": {"y": 3}, "c": 4}
...
def merge_dicts(dict1, dict2):
    ...
    for key, value in dict2.items():
        ...
        if key in dict1 and isinstance(dict1[key], dict) and isinstance(value, dict):
            ...
            # Otherwise, overwrite the value in the first dictionary with the
            # value from the second dictionary.
            dict1[key] = value
